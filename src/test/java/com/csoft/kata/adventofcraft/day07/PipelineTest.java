...
import static com.csoft.kata.adventofcraft.day07.dependencies.TestStatus.*;
...
class PipelineTest {
    ...
    void setUp() {
        ...
        Deployer deployer = new Deployer(log);
        EmailSummarySender emailSummarySender = new EmailSummarySender(config, emailer, log);
        pipeline = new Pipeline(testRunner, deployer, emailSummarySender);
    }
